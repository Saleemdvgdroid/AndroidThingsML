...
public class DemoCamera {
    private static final String TAG = DemoCamera.class.getSimpleName();
    ...
    private static class InstanceHolder {
        private static DemoCamera mCamera = new DemoCamera();
    }

    public static DemoCamera getInstance(Context xContext) {
